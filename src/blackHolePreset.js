// Built-in preset: a copy of "Martin - charisma" with the Interstellar
// black hole applied at the center. The blackHole flag turns on the
// geodesic lensing pass, which renders on top of the composed charisma
// frame: the hole's shadow sits in front, and all of charisma's light
// reaches the camera on geodesics bent by the hole (DNGR method).
/* eslint-disable */
const blackHolePreset = {
  ...
  "shapes": [
    {
      ...
      "init_eqs_eel": "",
      "frame_eqs_eel": "xy=0.5+rand_frame;"
    },
    {
      "baseVals": {
        "enabled": 0
  ...
  "name": "martin - charisma x gargantua",
  "blackHole": true
};
/* eslint-enable */
